...
(this, function(a) {
  ...
  , b.prototype.updateDetails=function() {
    ...
    if("undefined"!=typeof this.album[this.currentImageIndex].title&&""!==this.album[this.currentImageIndex].title) {
      ...
      this.options.sanitizeTitle?c.text(this.album[this.currentImageIndex].title):c.html(this.album[this.currentImageIndex].title.replace(/\r\n/g, "<br>").replace(/(\n|\r)/g, "<br>")), c.fadeIn("fast").find("a").on("click", function(b) {
